...
- 💻 **Full-Stack PHP** — do backend ao frontend
- 🗄️ **Banco de dados** — PostgreSQL e MySQL
- 🎓 **Acadêmico** — Ciência da Computação no IFC
- 💡 **Sempre aprendendo** — explorando novas ferramentas e linguagens
- 🎸 **Fora do código** — curto um bom Rock/Metal
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=php,java,nodejs,js,jquery,bootstrap,html,css,postgres,mysql,python,git,linux,vscode&theme=dark" alt="Skills" />
</p>
...
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:e10600,100:0d0d0d&height=120&section=footer" width="100%" />
</p>
